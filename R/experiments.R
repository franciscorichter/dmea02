sim.est <- function(n_trees, ct=15, pars, init_par=c(1.8,0.13,60),impsam=FALSE,seed=0,parallel=F){ # simulate a tree, drop fossil, and estimate parameters back after bootstrap reconstruction
